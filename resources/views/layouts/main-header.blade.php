								...
								<div class="dropdown nav-item main-header-notification">
									...
									<div class="dropdown-menu">
										<div class="menu-header-content bg-primary text-right">
											...
											<span class="badge badge-success badge-pill" id="notificationCount">{{auth()->user()->unreadNotifications->count()}}</span>
										</div>
										<div class="main-notification-list Notification-scroll" id="notifications">
