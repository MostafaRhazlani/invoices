						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								@can('الفواتير المدفوعة جزئيا')
									<li><a class="slide-item" href="{{ url('/' . $page='invoices_partiall') }}">الفواتير المدفوعة جزئيا</a></li>
								@endcan
								@can('ارشيف الفواتير')
									<li><a class="slide-item" href="{{ url('/' . $page='invoices_archive') }}">ارشيف الفواتير</a></li>
								@endcan
							</ul>
						</li>
					@endcan
